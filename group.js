...
document.querySelector("#mygroup_familybtn").addEventListener("click",()=>{
  document.querySelector(".groupcontainer").style.display="flex";
  document.querySelector(".mygroup_container").style.display="none";
})

document.querySelector("#mycreated_groupbtn").addEventListener("click",()=>{
  document.querySelector(".groupcontainer").style.display="none";
  document.querySelector(".mygroup_container").style.display="block";
})
...
// })
        ...
        function generateRandomName() {
          const alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"; // Alphabet characters
